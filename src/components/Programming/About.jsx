        ...
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0">
          ...
          >
            ...
            <h3 className="h3 mb-4 xs:text-[20px]">
              I'm a Freelance Frontend Developer with passion to code and eager
              to learn.
            </h3>
            <p className="mb-6 xs:text-[16px]">
              My adventure has started with basic
              <span className="text-orange-500 font-bold"> HTML</span> and
              <span className="text-blue-500 font-bold"> CSS</span>{" "}
              understanding with various courses and projects. Then I jumped
              right into
              <span className="text-yellow-500 font-bold"> JS</span> and after a
              month I understood basics and advanced features of this language.
              Now I master my
              <span className="text-cyan-300 font-bold"> React</span> skills day
              by day. Recently I extended my tool's library with{" "}
              <span className="text-blue-600 font-bold">TypeScript</span>.
            </p>
            {/* stats (change it to animated coding time) */}
