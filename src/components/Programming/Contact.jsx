...
const Contact = () => {
  ...
  const copyToClipboard = () => {
    const emailAdress = "sebastian.opozda.2305@gmail.com";
    ...
    <section id="contact" className="py-16 lg:section mb-28 lg:mb-0">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center lg:flex-row">
          ...
          >
            <div>
              <h4 className="h3 text-xl uppercase text-accent font-medium mb-2 tracking-wide">
                Get in touch
              </h4>
          ...
          >
            <h2 className="xs:h3 xs:uppercase sm:h2 text-center leading-10">
              How do <span className="text-accent font-bold">you</span> want to{" "}
              <span className="text-accent font-bold">contact me</span>?
            </h2>
            <div className="flex xs:flex-col xs: gap-y-12 sm:flex-row items-center justify-center gap-x-12 w-full">
              ...
              <div onClick={copyToClipboard} className="btn cursor-pointer p-4">
                Copy Email
              </div>
            </div>
          </motion.div>
